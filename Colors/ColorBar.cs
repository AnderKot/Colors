...
namespace Colors
{
	class ColorSlider : LabelRotate
	{
		...
		Color m_color2 = Color.FromArgb(255, 0, 0, 0);
    ...
    // --Отрисовка-- <<
		...
		protected void DrawColorBar(Graphics dc)
		{
			...
			if (m_numberOfColors == eNumberOfColors.Use2Colors)
				Util.Draw2ColorBar(dc, lr, Orientation, CurrColor.RGBClear, Color.Transparent);
			else
				Util.Draw3ColorBar(dc, lr, Orientation, m_color1, CurrColor.RGBClear, m_color3);
